...
Speed = Simulink.Parameter; % Define as parameter
Speed.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
Speed.Value = 0; % Initial value is set to zero, no override

Pspeed = Simulink.Parameter; % Define as parameter
Pspeed.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
Pspeed.Value = 30; % Initial value is set to zero, no override

Ispeed = Simulink.Parameter; % Define as parameter
Ispeed.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
Ispeed.Value = 4; % Initial value is set to zero, no override

Dspeed = Simulink.Parameter; % Define as parameter
Dspeed.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
Dspeed.Value = 1.3; % Initial value is set to zero, no override

MotorRPM = Simulink.Parameter; % Define as parameter
MotorRPM.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
MotorRPM.Value = 0; % Initial value is set to zero, no override

EncPosition = Simulink.Parameter; % Define as parameter
EncPosition.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
EncPosition.Value = 0; % Initial value is set to zero, no override



positionP = Simulink.Parameter; % Define as parameter
positionP.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
positionP.Value = 9; % Initial value is set to zero, no override

positionI = Simulink.Parameter; % Define as parameter
positionI.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
positionI.Value = 25; % Initial value is set to zero, no override

positionD = Simulink.Parameter; % Define as parameter
positionD.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
positionD.Value = 0.158; % Initial value is set to zero, no override

HantuneAngleSp = Simulink.Parameter; % Define as parameter
HantuneAngleSp.StorageClass = 'ExportedGlobal'; % Only Exported Global will be visible in HANtune
HantuneAngleSp.Value = 90; % Initial value is set to zero, no override
...
frequency_IRQ = 500; % IRQ every 100 ticks of hardware clock -> local clock: 10 kHz
...
comm_delay_measured1 = 0.0003; % [1Mb/s -> 0.3 ms] was 0.0003 %0.003 werkte redelijk
